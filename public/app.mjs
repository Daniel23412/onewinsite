...
try{savedLanguage=localStorage.getItem('voltpix.language')}catch{}
...
function gameUrl(id){
  const query=new URLSearchParams({game:id,lang:language,utm_source:'voltpix'});
...
select.addEventListener('change',()=>{
  ...
  try{localStorage.setItem('voltpix.language',language)}catch{}
