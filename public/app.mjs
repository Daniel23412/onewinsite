...
try{savedLanguage=localStorage.getItem('popstation.language')}catch{}
...
function gameUrl(id){
  const query=new URLSearchParams({game:id,lang:language,utm_source:'popstation'});
...
select.addEventListener('change',()=>{
  ...
  try{localStorage.setItem('popstation.language',language)}catch{}
