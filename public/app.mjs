...
try{savedLanguage=localStorage.getItem('foliohub.language')}catch{}
...
function gameUrl(id){
  const query=new URLSearchParams({game:id,lang:language,utm_source:'foliohub'});
...
select.addEventListener('change',()=>{
  ...
  try{localStorage.setItem('foliohub.language',language)}catch{}
